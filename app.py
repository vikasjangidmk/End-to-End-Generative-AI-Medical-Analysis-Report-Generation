...
file_uploaded = st.file_uploader("Upload the images for Analysis",type=['png','jpg','jpeg'])

if file_uploaded:
    st.image(file_uploaded,width=200,caption='Uploaded Images')
    
submit = st.button("Generate Analysis")

if submit:
    image_data = file_uploaded.getvalue()       # retrive binary data (RGB format pixel)
